...
public final class MecanumDrive {
    public static class Params {
        // IMU orientation
        // TO DO: fill in these values based on
        ...
        //default lateralInPerTick is inPerTick
        //emperical value
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 6825.07583;

        // feedforward parameters (in tick units)
        public double kS = 0.1;
        public double kV = 0.00031;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // TO DO: make sure your config has motors with these names (or change them)
