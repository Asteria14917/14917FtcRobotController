...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1989.436789; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1193.6620734; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        // TO DO: make sure your config has a Pinpoint device with this name
        ...
        // TO DO: reverse encoder directions if needed
